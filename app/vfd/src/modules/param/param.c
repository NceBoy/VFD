...
void param_default(void)
{
    ...
    g_vfdParam[PARAM0X02][PARAM_HIGH_FREQ_DELAY] = 8;// 开高频延时，单位0.1秒
    ...
    g_vfdParam[PARAM0X03][PARAM_WORK_END_SIGNAL] = 2;// 加工结束信号极性，0:常开 1:常闭 2:自适应极性
    ...
    g_vfdParam[PARAM0X03][PARAM_WIRE_BREAK_TIME] = 2;// 断丝检测时间，单位0.1秒
    g_vfdParam[PARAM0X03][PARAM_START_DIRECTION] = 0;// 丝筒启动方向，0:之前的方向，1:向左 ， 2:向右
